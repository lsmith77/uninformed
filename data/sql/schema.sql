CREATE TABLE clauses (clause_id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL, clause_process BIGINT, clause_number VARCHAR(255) NOT NULL, information_type BIGINT, operative_phrase BIGINT, adressee VARCHAR(255), relevance VARCHAR(255), significants VARCHAR(255), content TEXT, parent_id BIGINT, document_id BIGINT, created_at DATETIME, updated_at DATETIME, INDEX parent_id_idx (parent_id), INDEX clause_process_idx (clause_process), INDEX information_type_idx (information_type), INDEX operative_phrase_idx (operative_phrase), INDEX document_id_idx (document_id), PRIMARY KEY(clause_id)) DEFAULT CHARACTER SET utf8 ENGINE = InnoDB;
