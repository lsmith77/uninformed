...
/**
 * ClauseTagVersion filter form base class.
 *
 * @package    uninformed
 * @subpackage filter
 ...
 */
abstract class BaseClauseTagVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('clause_tag_version_filters[%s]');
