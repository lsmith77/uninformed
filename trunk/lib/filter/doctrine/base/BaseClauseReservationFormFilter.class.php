...
/**
 * ClauseReservation filter form base class.
 *
 * @package    uninformed
 * @subpackage filter
 ...
 */
abstract class BaseClauseReservationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'clause_body_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Clause'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('clause_reservation_filters[%s]');
