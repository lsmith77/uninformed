...
/**
 * BookmarkVersion filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseBookmarkVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('bookmark_version_filters[%s]');
