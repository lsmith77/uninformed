...
/**
 * DocumentReservation filter form base class.
 *
 * @package    uninformed
 * @subpackage filter
 ...
 */
abstract class BaseDocumentReservationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('document_reservation_filters[%s]');
