...
abstract class BaseClauseBodyVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'root_clause_body_id'   => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'root_clause_body_id'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
