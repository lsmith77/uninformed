...
/**
 * DocumentDocumentRelationVersion filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseDocumentDocumentRelationVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('document_document_relation_version_filters[%s]');
