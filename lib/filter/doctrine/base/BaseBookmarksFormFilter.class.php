...
/**
 * Bookmarks filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseBookmarksFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('bookmarks_filters[%s]');
