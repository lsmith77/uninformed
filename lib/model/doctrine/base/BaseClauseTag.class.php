 ...
 * @method ClauseTag setId()             Sets the current record's "id" value
 * @method ClauseTag setClauseBodyId()   Sets the current record's "clause_body_id" value
 * @method ClauseTag setTagId()          Sets the current record's "tag_id" value
 * 
 * @package    uninformed
 * @subpackage model
