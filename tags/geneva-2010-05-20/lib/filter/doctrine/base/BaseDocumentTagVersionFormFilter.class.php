...
/**
 * DocumentTagVersion filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseDocumentTagVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('document_tag_version_filters[%s]');
