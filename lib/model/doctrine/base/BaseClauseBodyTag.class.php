 ...
 * @method ClauseBodyTag setId()             Sets the current record's "id" value
 * @method ClauseBodyTag setClauseBodyId()   Sets the current record's "clause_body_id" value
 * @method ClauseBodyTag setTagId()          Sets the current record's "tag_id" value
 * 
 * @package    symfony
 * @subpackage model
 ...
 */
abstract class BaseClauseBodyTag extends MyBaseRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('clause_body_tag');
