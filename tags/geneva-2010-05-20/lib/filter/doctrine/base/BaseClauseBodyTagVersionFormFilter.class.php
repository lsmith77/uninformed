...
/**
 * ClauseBodyTagVersion filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseClauseBodyTagVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('clause_body_tag_version_filters[%s]');
