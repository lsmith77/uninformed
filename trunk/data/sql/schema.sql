CREATE TABLE clauses (clause_id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL, clause_number VARCHAR(255) NOT NULL, information_type VARCHAR(255), operative_phrase VARCHAR(255), adressee VARCHAR(255), relevance VARCHAR(255), significants VARCHAR(255), content TEXT, parent_id BIGINT, document_id BIGINT, created_at DATETIME, updated_at DATETIME, INDEX parent_id_idx (parent_id), INDEX document_id_idx (document_id), PRIMARY KEY(clause_id)) DEFAULT CHARACTER SET utf8 ENGINE = InnoDB;
...
CREATE TABLE documents (document_id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL, publication_date DATE NOT NULL, adoption_date DATE, code VARCHAR(255), min_ratification_count INT, preamble TEXT, parent_id BIGINT, organisation_id BIGINT, documenttype_id BIGINT, created_at DATETIME, updated_at DATETIME, INDEX parent_id_idx (parent_id), INDEX organisation_id_idx (organisation_id), INDEX documenttype_id_idx (documenttype_id), PRIMARY KEY(document_id)) DEFAULT CHARACTER SET utf8 ENGINE = InnoDB;
