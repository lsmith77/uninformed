...
/**
 * ClauseReservationVersion filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseClauseReservationVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'clause_body_id' => new sfWidgetFormFilterInput(),
    ...
    $this->widgetSchema->setNameFormat('clause_reservation_version_filters[%s]');
