...
CREATE TABLE documents (document_id INT UNSIGNED AUTO_INCREMENT, name VARCHAR(45) NOT NULL, documenttype_id INT UNSIGNED NOT NULL, publication_date DATE NOT NULL, adoption_date DATE, organisation_id INT UNSIGNED NOT NULL, code VARCHAR(45), legal_value VARCHAR(45), min_ratification_count INT, preamble TEXT, created_at DATETIME, updated_at DATETIME, INDEX documenttype_id_idx (documenttype_id), INDEX organisation_id_idx (organisation_id), PRIMARY KEY(document_id)) ENGINE = INNODB;
