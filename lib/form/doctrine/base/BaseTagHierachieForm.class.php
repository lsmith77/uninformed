...
/**
 * TagHierachie form base class.
 *
 * @package    form
 * @subpackage tag_hierachie
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseTagHierachieForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'parent_taghierachie_id' => new sfWidgetFormInput(),
      'tags_list'              => new sfWidgetFormDoctrineChoiceMany(array('model' => 'Tag')),
    ));

    $this->setValidators(array(
      'taghierarchie_id'       => new sfValidatorDoctrineChoice(array('model' => 'TagHierachie', 'column' => 'taghierarchie_id', 'required' => false)),
      'name'                   => new sfValidatorString(array('max_length' => 45)),
      'hierachie_level'        => new sfValidatorChoice(array('choices' => array('area' => 'area', 'issue' => 'issue', 'keyword' => 'keyword'))),
      'parent_taghierachie_id' => new sfValidatorInteger(array('required' => false)),
      'tags_list'              => new sfValidatorDoctrineChoiceMany(array('model' => 'Tag', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('tag_hierachie[%s]');
