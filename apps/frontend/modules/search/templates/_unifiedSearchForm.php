<form action="<?php echo url_for('search'); ?>" method="GET" id="us_form" data-ajaxAction="<?php echo url_for('searchActions', array('action' => 'results')); ?>">
    <div id="help_and_link">
        <a id="us_search_link" data-baseUrl="<?php echo url_for('search', array(), true); ?>" style="display:none;">Link to this search</a>
