...
/**
 * Votingrecords form base class.
 *
 * @package    form
 * @subpackage votingrecords
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseVotingrecordsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'document_id'    => new sfValidatorDoctrineChoice(array('model' => 'Votingrecords', 'column' => 'document_id', 'required' => false)),
      'memberstate_id' => new sfValidatorDoctrineChoice(array('model' => 'Votingrecords', 'column' => 'memberstate_id', 'required' => false)),
      'vote_type'      => new sfValidatorChoice(array('choices' => array('signed' => 'signed', 'agreed' => 'agreed', 'no' => 'no', 'abstain' => 'abstain', 'missing' => 'missing'))),
    ));

    $this->widgetSchema->setNameFormat('votingrecords[%s]');
