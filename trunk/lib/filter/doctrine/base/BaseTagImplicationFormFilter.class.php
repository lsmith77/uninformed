...
abstract class BaseTagImplicationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'implied_tag_id'   => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TagImplied'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'implied_tag_id'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('TagImplied'), 'column' => 'id')),
